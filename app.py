...
def insertar_firma_y_texto_en_pdf(pdf_bytes, firma_img, nombre, recinto, fecha_str, rut, observacion, firma_width=150):
    ...
    # Insertar texto
    pagina.insert_text((150, 580), nombre, fontsize=12, fontname="helv", fill=(0, 0, 0))
    pagina.insert_text((150, 598), recinto, fontsize=12, fontname="helv", fill=(0, 0, 0))
    ...
    pagina.insert_text((80, 800), "Observación:", fontsize=12, fontname="helv", fill=(0, 0, 0))
